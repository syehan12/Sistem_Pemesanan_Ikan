...
if(isset($_POST['btnLogin'])){
	...
	$loginQry = mysqli_query($mysqli, $loginSql) or die ("Gagal query password".mysqli_error($mysqli));
	...
	if (count($pesanError)>=1 ) {
		...
		if ($loginQty >=1) {
			...
			mysqli_query($mysqli, $hapusSql) or die ("Gagal query hapus".mysqli_error($mysqli));
