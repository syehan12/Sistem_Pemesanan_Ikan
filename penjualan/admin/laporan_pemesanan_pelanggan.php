...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-list" >
  <tr>
    ...
    <th width="13%" align="right" bgcolor="#CCCCCC">
      <font color="#FF0066">Total Pesanan</font>
    </th>
  ...
  $mySql = "SELECT pemesanan.*, pelanggan.nm_pelanggan FROM pelanggan, pemesanan WHERE pelanggan.kd_pelanggan = pemesanan.kd_pelanggan AND $SqlPeriode ORDER BY no_pemesanan DESC";
  ...
  <tr>
    ...
    <td width="6%" align="center"><a href=?open=Pemesanan-Lihat&Kode=<?php echo $Kode; ?> target="_blank" class="btn btn-info btn-sm">Lihat</a> </td>
  </tr>
  <?php } ?>
</table>
